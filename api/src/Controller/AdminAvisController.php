...
/**
 * Alias des routes de modération sous /api/admin/avis pour matcher
 * le front admin.html (comme pour AdminCommandeController).
 *
 * Délègue au même AvisService.
 */
...
class AdminAvisController extends AbstractController
{
    ...
    public function liste(Request $request): JsonResponse
    {
        ...
        return $this->json(
            array_map(fn($a) => $this->serializer->toArrayModeration($a), $this->avis->findByStatut($statut))
        );
    }
